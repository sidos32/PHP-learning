...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P8G7CKX"
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <div class="card" style="width: 15rem;">
            <img src="https://upload.wikimedia.org/wikipedia/commons/a/ac/No_image_available.svg" class="card-img-top" alt="Бавна връзка">
            <div class="card-body">
