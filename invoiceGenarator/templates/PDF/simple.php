...
$this->data .= "<div id='bigi'>ФАКТУРА</div>";

// BILL TO
$this->data .= "<table id='billship'><tr><td><strong>Данни за фактуриране:</strong><br>";
foreach ($this->billto as $b) { $this->data .= $b."<br>"; }

// SHIP TO
$this->data .= "</td><td><strong>Доставка за:</strong><br>";
...
// ITEMS
$this->data .= "<table id='items'><tr><th>Артикул</th><th>Количество</th><th>Цена</th><th>Общо</th></tr>";
foreach ($this->items as $i) {
	$this->data .= "<tr><td><div>".$i[0]."</div>".($i[1]==""?"":"<small class='idesc'>$i[1]</small>")."</td><td>".$i[2]."</td><td>".$i[3]."лв.</td><td>".$i[4]."лв.</td></tr>";
}
